            ...
            <div className="border-b border-solid border-border_color rounded-bl-2xl rounded-br-2xl">
                <Flex className="w-[95%] mx-auto justify-between py-5 md:py-2">
                    <Flex className="justify-between w-[80%] relative md:w-[50%]">
                        <h3 className={`text-md font-bold text-primary select-none pointer-events-none md:text-xl lg:text-2xl`}>
                            CodeVerse — A Developer's Diary
                        </h3>
                        <Flex className={"w-[300px] border border-solid border-border_color px-5 py-2 rounded-2xl hidden lg:flex"}>
                            <CiSearch className="text-primary text-lg mr-3" />
                            <input type="text" className="w-full text-md text-secondary focus:border-none outline-none" placeholder="Search here >>>>>" />
                        </Flex>
                    </Flex>
                    ...
                    <Flex className={"rounded-tl-2xl rounded-tr-2xl justify-around fixed border border-solid border-border_color bottom-0 left-0 bg-card_bg w-full py-6 md:relative md:bg-bg md:w-[200px] md:border-none z-10"}>
                        <CiSearch className="text-primary text-lg mr-3 lg:hidden" />

                        <Flex className='gap-x-1 cursor-pointer'>
                            <TfiWrite className="text-primary text-lg mr-1" />
